...
CHIP-8 is a virtual console definition from the 1970s by Joseph Weisbecker.
...
If distributed on a disk with [ProDOS-8 2.4](https://prodos8.com/) and the file is named `BASIS.SYSTEM` then files selected in [Bitsy Bye](https://prodos8.com/bitsy-bye/) will launch it automatically.
