...
for i in $(seq 1 10); do
  add_file "res/octojam${i}title.ch8" "DEMOS/OCTOJAM${i}.CH8#5DC803"
done

# Games from https://www.zophar.net/pdroms/chip8/chip-8-games-pack.html
add_file "res/15PUZZLE.ch8" "GAMES/PUZZLE15.CH8#060000"
add_file "res/BLINKY.ch8" "GAMES/BLINKY.CH8#5DC83C"
add_file "res/BLITZ.ch8" "GAMES/BLITZ.CH8#060000"
add_file "res/BRIX.ch8" "GAMES/BRIX.CH8#060000"
add_file "res/CONNECT4.ch8" "GAMES/CONNECT4.CH8#5DC83C"
add_file "res/GUESS.ch8" "GAMES/GUESS.CH8#060000"
add_file "res/HIDDEN.ch8" "GAMES/HIDDEN.CH8#5DC80D"
add_file "res/INVADERS.ch8" "GAMES/INVADERS.CH8#5DC83C"
...
add_file "res/TICTAC.ch8" "GAMES/TICTAC.CH8#5DC83C"
